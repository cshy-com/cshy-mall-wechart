...
import { HTTP_ADMIN_URL, PHONE } from '@/config/app.js';
import store from '../store';
import {
    pathToBase64
} from '@/plugin/image-tools/index.js';
import { getServiceTelephone } from "@/api/api"
export default {
    /**
     * opt  object | string
    ...
    async makePhoneCall(number) {
        ...
        // let { data } = await getServiceTelephone()
        // uni.showActionSheet({
        //     itemList: data,
        //     success: function(res) {
        //         uni.makePhoneCall({
        //             phoneNumber: data[res.tapIndex] || PHONE,
        //             success: function() {
        //                 console.log('拨打电话成功！')
        //             },
        //             fail: function() {

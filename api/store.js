 ...
 * 
 */
export function getProductDetail(id, type, isGiftCard = 0) {

    return request.get('product/detail/' + id + '?type=' + type + '&isGiftCard=' + isGiftCard, {}, {
        noAuth: true
    });
}
...
export function getCateParent(id) {
    return request.get('category/parent', {}, {
        noAuth: true
    })
}
export function getCateChild(data) {
    return request.get('category/children', data, {
        noAuth: true
    })
}
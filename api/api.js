...
// 获取客服电话
export function getServiceTelephone(params) {
    return request.get('common/contact/phone', params, { noAuth: true });
}
export function bannerActivityConfigPage(params) {
    return request.get('sys/banner/activity/config/obj/1', params, { noAuth: true });
}

export function activityQueryProductList(params) {
    return request.get('activity/secKill/query/productList', params, { noAuth: true });

}
export function activityQueryById(params) {
    return request.get('activity/secKill/query/byId', params, { noAuth: true });

}

// 礼品卡列表
export function giftCardByType(params) {
    return request.get('giftCard/get/byType', params, { noAuth: true });

}
export function productListCategoryFeature(params) {
    return request.get('product/list/category/feature', params, { noAuth: true });
}
export function activitySecKillQueryByCateId(params) {
    return request.get('activity/secKill/query/byCateId', params, { noAuth: true });
}
// 查询首页
export function homeConfigList(params) {
    return request.post('sys/home/config/list', params, { noAuth: true });
}
...
export function getSeckillIndexTime() {
    return request.get('activity/secKill/index', {}, { noAuth: true });
}
...
export function getSeckillList(time, data) {
    return request.get('activity/secKill/list/' + time, data, { noAuth: true });
}
...
export function getSeckillDetail(id) {
    return request.get('activity/secKill/detail/' + id);
}
...
export function seckillCode(id, data) {
    return request.get("activity/secKill/code/" + id, data);
}
...
export function getSeckillHeaderApi() {
    return request.get('activity/secKill/header', {}, { noAuth: true });
}
...
// 根据提货码获取商品列表或者订单信息
export function giftCardGetInfoByPickupCode(params) {
    return request.get('giftCard/getInfoByPickupCode', params, { noAuth: true });
}

// 礼品卡下订单

export function giftCardOrderAdd(data) {
    return request.post('giftCard/order/add', data);
}
// 查询物流
export function expressFindExpressDetail(params) {
    return request.get('express/findExpressDetail', params, { noAuth: true });
}
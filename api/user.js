...
export function historyPage(data) {
    return request.post('user/visit/history/page', {...data });
}
// 删除浏览记录

export function delHistory(data) {
    return request.post('user/visit/history/delete', data);
}
// 意见建议----新增
export function advicesAdd(data) {
    return request.post('advices/add', {...data });
}
//  意见建议-----列表
export function advicesList(data) {
    return request.post('advices/myList', {...data });
}
// 意见建议----详情
export function advicesInfo(params) {
    return request.get('advices/details', params);
}
...
// 常见问题----详情
export function faqDateil(id) {
    return request.get('faq/obj/' + id);
}
// 常见问题---类型
export function categoryPage(data) {
    return request.post('faq/category/page', {...data });
}
// 获取openid
export function userGetToken(params) {
    return request.get('user/get/openid', params);
}
// 是否存在openid
export function userToken(params) {

    return request.get('user/token', params);
}

// 领取积分
export function couponAdd(params) {

    return request.get('integral/coupon/add', params);
}
export function couponStatus(params) {

    return request.get('integral/coupon/isUsed', params, { noAuth: true });
}
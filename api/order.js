...
export function operationList(params) {
    return request.get('order/operation/list', params);
}
...
export function refundShipApi(data) {
    return request.post(`order/refund/ship`, data);
}
// 撤销售后
export function refundRevoke(params) {
    return request.get(`order/refund/revoke`, params);
}
// 计算退款的价格
export function orderRefundCompute(data) {
    return request.post(`order/refund/compute`, data);
}
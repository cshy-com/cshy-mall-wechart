	...
	<view>
		...
		<view class="product-window"
			...
			<view class="textpic acea-row row-between-wrapper">
				<view class="pictrue">
					<image :src="attr.productSelect.image||productInfo.image "></image>
				</view>
				<view class="text">
					<view class="line1">
					...
					<view class="money font-color">
						...
						<text class="num">{{ attr.productSelect.price }}</text>元
					</template>
			 
						<text class="stock" v-if='isShow&&isShowInventory'>库存: {{ attr.productSelect.stock }}</text>
			...
			<view class="rollTop">
				...
				<view class="cart acea-row row-between-wrapper" >
					...
					<template v-else><view   class="item plus on">+</view></template>
...
.mask{
	...
	.product-window .textpic {
		...
		margin-top: 22rpx;
		height: 135rpx;border-bottom: 1px solid #EEEEEE;
...
.h-line{
	...
	.product-window .productWinList .item .listn .itemn {
		...
		background: #EFEFEF;color: #2B2B2B;
	}

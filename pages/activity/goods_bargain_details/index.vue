		...
		<view class='bargain'>
			...
			<view class="pad30" style="padding-bottom: 30rpx;">
				...
				<view class='bargainTip' :class='active==true?"on":""'>
					<view class='pictrue'>
						<image src="https://cshy.store/file/sysFile/wechart/bargainBg.png"></image>
					</view>
	...
	export default {
		...
		data() {
			return {
				...
				buyPrice: '', //最后砍价购买价格
				qrcodeSize: 600,
				posterbackgd: 'https://cshy.store/file/sysFile/wechart/canbj.png',
				PromotionCode: '', //二维码
				canvasStatus: false,
				imgTop: '', //商品图base64位
				imagePath: '' // 海报图片
...
<style lang="scss" scoped>
	...
	.bargain {
		...
		.content {
			width: 100%;
			height: auto;
			background-image: url('https://cshy.store/static/zhuangshi.png');
			background-size: 100% 100%;
			background-color: #fff;
	...
	.bargain .bargainBnt {
		...
		width: 630rpx;
		height: 80rpx;
		background-image: url('https://cshy.store/static/btn.png');
		background-size: 100% 100%;
		// border-radius: 40rpx;
		// background: linear-gradient(180deg, #FF8831 0%, #F11B09 100%);
		text-align: center;
	...
	.bargain .bargainGang .list .item .pictxt {
		...
		.num1 {
			background-image: url(https://cshy.store/static/n1.png);
			background-repeat: no-repeat;
			background-size: 100% 100%;
		}

		.num2 {
			background-image: url(https://cshy.store/static/n2.png);
			background-repeat: no-repeat;
			background-size: 100% 100%;
		}

		.num3 {
			background-image: url(https://cshy.store/static/n3.png);
			background-repeat: no-repeat;
			background-size: 100% 100%;
		}
	}

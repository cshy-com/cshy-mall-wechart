	...
	<view class="register absolute">
	    <view class="shading">
	      <view class="pictrue acea-row row-center-wrapper">
			 <image src="https://cshy.store/file/sysFile/wechart/logo2.png"></image>
	      </view>
	    </view>
	    <view class="whiteBg">
	      ...
	      <view class="list">
	        <view class="item">
	          <view class="acea-row row-middle">
				<image src="https://cshy.store/file/sysFile/wechart/phone_1.png"></image>
	        ...
	        <view class="item">
	          <view class="align-left acea-row row-middle">
				<image src="https://cshy.store/file/sysFile/wechart/code_2.png"></image>
	        ...
	        <view class="item">
	          <view class="acea-row row-middle">
	            <image src="https://cshy.store/file/sysFile/wechart/code_1.png"></image>

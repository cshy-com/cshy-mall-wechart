		...
		<view class='productList'>
			...
			<view class='nav acea-row row-middle'>
				...
				<view class='item' @click='set_where(2)'>
					价格
					<image v-if="price==1" src='https://cshy.store/file/sysFile/wechart/up.png'></image>
					<image v-else-if="price==2" src='https://cshy.store/file/sysFile/wechart/down.png'></image>
					<image v-else src='https://cshy.store/file/sysFile/wechart/horn.png'></image>
				</view>
				<view class='item' @click='set_where(3)'>
					销量
					<image v-if="stock==1" src='https://cshy.store/file/sysFile/wechart/up.png'></image>
					<image v-else-if="stock==2" src='https://cshy.store/file/sysFile/wechart/down.png'></image>
					<image v-else src='https://cshy.store/file/sysFile/wechart/horn.png'></image>
				</view>
				<!-- down -->
...
<script>
	...
	export default {
		...
		onLoad: function(options) {
			...
			this.$set(this.where, 'minSalePrice', options.minSalePrice || '');
			this.$set(this.where, 'maxSalePrice', options.maxSalePrice || '');
